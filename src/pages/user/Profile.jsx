      ...
      ({ closeToast }) => (
        <div className="custom-toast-confirm">
          ...
          <p className="toast-desc">
            Esta ação é irreversível e vais perder todos os teus dados.
          </p>
      ...
      {!isEditing ? (
        <div className="profile-view">
          ...
          <div className="profile-row">
            ...
            <span className="profile-value">
              {user.morada?.cidade}, {user.morada?.codigoPostal}
            </span>
          </div>
          <div className="profile-row">
        ...
        <form onSubmit={handleSubmit(onUpdate)} className="profile-edit-form">
          ...
          <div className="profile-grid">
            ...
            <div className="profile-field">
              ...
              <input
                {...register("morada.codigoPostal", { required: true })}
            ...
            <div className="profile-field">
              <label>Cidade</label>
              <input
                {...register("morada.cidade", { required: true })}
                placeholder="Lisboa"
              />
            </div>
            <div className="profile-field">
              <label>País</label>
              <input
                {...register("morada.pais", { required: true })}
          ...
          <div className="pass-group">
            <small>
              Deixa em branco se não pretenderes alterar a palavra-passe atual.
            </small>
            <div className="profile-field">
